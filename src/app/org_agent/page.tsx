...
import OrgAgentFlow from '@/components/OrgAgent/OrgAgentFlow';
import DepartmentCards from '@/components/OrgChart3/DepartmentCards';
import { motion, AnimatePresence } from 'framer-motion';
import { ChevronUpIcon, ChevronDownIcon, UserIcon, CpuChipIcon } from '@heroicons/react/24/outline';
    ...
    <div className="flex flex-col h-full">
        ...
        >
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-bold text-gray-900">AI-Enhanced Organization</h1>
              <span className="bg-violet-100 text-violet-800 text-xs px-2 py-1 rounded-full font-medium">New</span>
            </div>
            <p className="text-gray-500">Plan and visualize your hybrid workforce with humans and AI systems</p>
          </div>
      ...
      <div className="flex-grow overflow-hidden flex flex-col">
        ...
        <div className="flex-grow overflow-hidden">
          <OrgAgentFlow projectionPeriod={projectionPeriod} />
        </div>
