...
import OrgChart2Flow from '@/components/OrgChart2/OrgChart2Flow';
import DepartmentCards from '@/components/OrgChart2/DepartmentCards';
...
export default function OrgChart2Page() {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-grow overflow-hidden flex flex-col">
        ...
        <div className="flex-grow overflow-hidden">
          <OrgChart2Flow projectionPeriod={projectionPeriod} />
        </div>
